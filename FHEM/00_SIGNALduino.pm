##############################################
# $Id: 00_SIGNALduino.pm 10488 2018-01-28 15:00:00Z v3.3.2 $
#
# v3.3.2 (release 3.3)
...
my %ProtocolListSIGNALduino  = (
	...
	# MU;P0=-1384;P1=815;P2=-2725;P3=-20001;P4=8159;P5=-891;D=1345101210101210101212101010101012121212101010121010;CP=1;
	"13.1"    => 			## FLAMINGO FA20 
		{
